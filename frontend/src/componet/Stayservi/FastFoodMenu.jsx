...
const SAMPLE_ITEMS = [
  ...
  },
  {
    ...
    description: 'Classic slice topped with mozzarella and pepperoni.',
    price: 4.25,
    category: 'Pizza',
    calories: 380,
    vegetarian: false,
  ...
  },
  {
    id: '5',
    name: 'Milkshake',
    description: 'Creamy vanilla or chocolate milkshake topped with whipped cream.',
    price: 5.0,
    category: 'Drinks',
    calories: 450,
    vegetarian: true,
    image: 'https://images.unsplash.com/photo-1600891964093-4316c288032e?q=80&w=800&auto=format&fit=crop',
  },
];
    ...
    <Box sx={{ p: { xs: 2, md: 4 } }}>
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} alignItems="center" justifyContent="space-between" sx={{ mb: 3 }}>
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          <div>
            <Typography variant="h5">Fast Food Menu</Typography>
            <Typography variant="body2" color="text.secondary">Quick, tasty, and satisfying — explore our fast food options.</Typography>
          </div>
        </Stack>

        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} alignItems="center">
          <TextField size="small" placeholder="Search fast food..." value={query} onChange={(e) => setQuery(e.target.value)} />
